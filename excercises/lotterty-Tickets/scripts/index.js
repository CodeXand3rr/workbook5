...
let winningTickets = [ 
    ...
    window.onload = function () {
        ...
        const winningTicketsTb1Body = document.querySelector("#winningTicketsTb1Body");
      
        //functions
        function  loadWinningTicketsTable() {
for (const winningTicket of winningTickets ) {
//    let row = document.createElement("tr")
    // let row = winningTicketsTb1Body.appendChild(row);
    let row = winningTicketsTb1Body.insertRow();
   
    let cell1 = row.incertCell(0);
    cell1.innerText = winningTicket.tixNum

    let cell2 = row.incertCell(1);
    cell2.innerText = "$" + winningTicket.prize

    let cell3 = row.incertCell(2);
